...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 104857600;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 104857600, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 104857600);
...
var ASM_CONSTS = {
  2917868: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2917923: function($0) {performance.now = function() { return $0; };},  
 2917971: function($0) {performance.now = function() { return $0; };},  
 2918019: function() {performance.now = Module['emscripten_get_now_backup'];},  
 2918074: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2918135: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2918199: function() {return Module.webglContextAttributes.powerPreference;}
};
